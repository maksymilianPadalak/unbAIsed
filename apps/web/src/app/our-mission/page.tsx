      ...
      <div className="max-w-3xl md:max-w-4xl lg:max-w-5xl mx-auto px-4 sm:px-8 py-10 sm:py-16">
        <div className="brutalist-border bg-black p-6 sm:p-10">
          ...
          <div className="space-y-5 text-white font-mono leading-relaxed text-base sm:text-lg">
            <p>
              As the creator, my goal is to build the best possible algorithm
            ...
            <p>
              That is why this project will forever remain open source. I would
              love to hear all your ideas on how to make the scoring algorithm
              better.
            </p>
            <p className="opacity-80">
              If you have suggestions, critiques, or data sources we should
              incorporate, please share them. Together we can create a standard
